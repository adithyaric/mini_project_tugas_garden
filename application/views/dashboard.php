		...
		<table class="table table-bordered table-striped ">
			...
			?>
				<tr>
					...
					<td>
						<center><?php echo $akn->foto; ?></center>
					</td>
					<td><?php echo $akn->username; ?></td>
					<td><?php echo $akn->email; ?></td>
					<td>
						<center><?php echo anchor('dashboard/detail/' . $akn->id, '<div class="btn btn-success bt-sm"><i class="fa fa-search-plus "></i></div>') ?></center>
					</td>
					<td onclick="javascript: return confirm('Anda yakin hapus?')">
						<center><?php echo anchor('dashboard/hapus/' . $akn->id, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></center>
					</td>
					<td>
						<center><?php echo anchor('dashboard/edit/' . $akn->id, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></center>
					</td>
				</tr>
			<?php endforeach; ?>
		</table>
